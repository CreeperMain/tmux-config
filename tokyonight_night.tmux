...
if-shell '[ "$(tmux show-option -gqv "clock-mode-style")" == "24" ]' {
	set -g status-right "#[fg=#1a1b26,bg=#1a1b26,nobold,nounderscore,noitalics]#[fg=#7aa2f7,bg=#1a1b26] #{prefix_highlight} #{battery_status_bg} #{battery_icon} #{battery_percentage} #{battery_remain}  #[fg=#b4f9f8,bg=#1a1b26,nobold,nounderscore,noitalics]#[fg=#15161e,bg=#b4f9f8,nobold] %H:%M %d %b #[fg=#73daca,bg=#b4f9f8,nobold,nounderscore,noitalics]#[fg=#15161e,bg=#73daca] AD %Y ┃ #(expr %Y + 5509) AM "
}
